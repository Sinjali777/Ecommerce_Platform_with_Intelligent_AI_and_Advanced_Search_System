...
async def chat(req: ChatRequest):
   ...
   # Build system prompt
    if do_search and laptop_context:
        system_prompt = f"""
You are ElectroV AI, a friendly and knowledgeable laptop shopping
...
- If user's exact request isn't available, suggest closest alternative
        ...
        system_prompt = """
You are ElectroV AI, a friendly laptop shopping assistant
for ElectroV — a Nepal-based laptop electronics store.
